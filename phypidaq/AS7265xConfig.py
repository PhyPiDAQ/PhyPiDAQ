...
class AS7265xConfig(object):
    ...
    def closeDevice(self):
        self.AS7265x.setBlueLED(1)  # LED on indicates standby, uninitialized(LED is ON, when powered)
...
class AS7265x(object):
    ...
    # Calibrated data comes back as IEEE754 encoded number (sign/mantissa/fraction). Need to convert to a float.
    # See Spec page 27.
    ...
    def reorderData(self, unsortedData):
        ...
        for pairs in mappings:
            sortedData[pairs[1] - 1] = unsortedData[pairs[0] - 1]
            # -1 is to correct for 1st list member being in position 0
    ...
    def initDev(self):
        ...
        # immediately you get [Errno 121] Remote I/O error
