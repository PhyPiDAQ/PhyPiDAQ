...
class Ui_PhyPiWindow(object):
    def setupUi(self, PhyPiWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./phypidaq/images/start.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./phypidaq/images/open-folder.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./phypidaq/images/application-exit.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 20, 221, 17))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./phypidaq/images/ok.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("./phypidaq/images/flagUK.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("./phypidaq/images/flagDE.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, PhyPiWindow):
        ...
        self.label_3.setText(_translate("PhyPiWindow", "Development for Pi OS 11"))
