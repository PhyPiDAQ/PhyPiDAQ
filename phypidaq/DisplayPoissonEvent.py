...
#       self.flash_color = '#ffff80' # yellowish
       ...
       self.fig = plt.figure("PoissonFlash 𝜏=%.3g"%(self.tau), figsize=(6., 8.))
       ...
       c1 = patches.Circle((0, 0.), 1, ec="#4F4F4F", lw=20)
       c2 = patches.Circle((0, 0.), 1.1, ec="#2F2F2F", lw=60)
       c3 = patches.Circle((0, 0.), 1.4, ec="#1F1F1F", lw=20)
